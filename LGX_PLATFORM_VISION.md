...
| v1.2 | Graphics (Vulkan wrapper) | Q2 2026 | Planning |
| v1.3 | Input (gamepad, keyboard, mouse) | Q3 2026 | Planned |
...
2. **The foundation is solid.** v1.0 and v1.1 are production-tested, with 69 passing tests, comprehensive docs, and performance that exceeds targets by 10-200×.
